...
const styles: { [key: string]: string } = {
  ...
  videoCreationDiv: 'w-3/4 flex flex-row justify-start gap-2 ' + 'md:flex-col md:w-3/4 ' + 'sm:flex-col sm:w-3/4',
  ...
  descriptionDivTitleText: 'text-2xl font-medium brightness-75 ' + 'lg:text-base ' + 'md:text-xs ' + 'sm:text-[0.5rem]',

  descriptionDivSubtitleText:
    'text-2xl font-semibold text-yellow-300 ' + 'llg:text-base ' + 'md:text-xs ' + 'sm:text-[0.5rem]',

  descriptionDivText: 'text-2xl ' + 'lg:text-base ' + 'md:text-xs ' + 'sm:text-[0.35rem] ',
    ...
    <Fragment>
      <div className={`mainDiv ${styles['mainDiv']}`}>
        ...
        <div className={`Home/descriptionDiv ${styles['descriptionDiv']}`}>
          <div className={`Home/descriptionDivTextDiv ${styles['descriptionDivTextDiv']}`}>
            <p className={`Home/descriptionDivTitleText ${styles['descriptionDivTitleText']}`}>
              {textData.page.screen.home.title}
            </p>
            <p className={`Home/descriptionDivSubtitleText ${styles['descriptionDivSubtitleText']}`}>
              {textData.page.screen.home.subtitle}
            </p>
            <p className={`Home/descriptionDivText ${styles['descriptionDivText']}`}>
