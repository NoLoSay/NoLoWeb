      ...
      <Fragment>
        <div className={`divBlockTitlePage ${styles['divBlockTitlePage']}`}>
          <ButtonBase
            ...
            onClick={() => navigate(-1)}
          >
            <div className={styles.buttons}>{textData.page.screen.exhibitions.back}</div>
          </ButtonBase>
          ...
          >
            <div className={styles.buttons}>{textData.page.screen.exhibitions.addExhibition}</div>
          </ButtonBase>
        </div>
                  ...
                  <div className={`divBlockExhibitionInfos ${styles['divBlockExhibitionInfos']}`}>
                    <div className={`divExhibitionChangeBtn ${styles['divExhibitionChangeBtn']}`}>
                      ...
                      <div className={`divModifyButtons ${styles['divModifyButtons']}`}>
                        ...
                        >
                          <div className={styles.buttons}>{textData.page.screen.exhibitions.modification}</div>
                        </ButtonBase>
                        <ButtonBase
                          disableRipple
                          onClick={() => handleAction('deleteButton', exhibition.id)}
                        >
                          <div className={styles.buttons}>{textData.page.screen.exhibitions.remove}</div>
                        </ButtonBase>
                      </div>
                    </div>
                    <div className={`divBlockExhibitionInformations ${styles['divBlockExhibitionInformations']}`}>
                      <div className={`divExhibitionInformations ${styles['divExhibitionInformations']}`}>
                        <div className={`divGeneralInformation ${styles['divGeneralInformation']}`}>
                          <div className={`placeText ${styles['placeText']}`}>
                            ...
                            {exhibition.site.address.City && exhibition.site.address.City.Department
                          ...
                          <div className={`dateText ${styles['dateText']}`}>
                            ...
                            {new Date(exhibition.startDate).toLocaleDateString()} <br />{' '}
                            {textData.page.screen.exhibitions.to} {new Date(exhibition.endDate).toLocaleDateString()}
                          </div>
                          <div className={`priceText ${styles['priceText']}`}>
                            {exhibition.site.price} {textData.page.screen.exhibitions.euro}
                          </div>
                          <div className={`artworkNbText ${styles['artworkNbText']}`}>
                            {' '}
                      ...
                      <div className={`divBlockGoToArtworksBtn ${styles['divBlockGoToArtworksBtn']}`}>
                        ...
                        >
                          <div className={styles.buttons}>{textData.page.screen.exhibitions.allArtworks}</div>
                        </ButtonBase>
                      </div>
                    </div>
                  </div>
