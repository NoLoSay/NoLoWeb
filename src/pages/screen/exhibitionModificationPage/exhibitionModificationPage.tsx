    ...
    if (location.state?.exhibition) {
      setExhibition({
        ...
        createdAt: location.state.exhibition.createdAt
          ? new Date(location.state.exhibition.createdAt).toISOString().slice(0, 10)
          : new Date().toISOString().slice(0, 10),
        endDate: location.state.exhibition.endDate
          ? new Date(location.state.exhibition.endDate).toISOString().slice(0, 10)
          : new Date().toISOString().slice(0, 10),
      })
    }
  }, [location.state])
      ...
      <section className={styles.exhibitionModificationPage}>
        ...
        >
          <div className={styles.divBlockGeneralInformations}>
            ...
            <div className={styles.divGeneralInformations}>
              ...
              <div className={styles.descriptionText}>
                {textData.page.screen.exhibitionModificationPage.shortdescription}
              </div>
              <input
                type='text'
              ...
              />
              <div className={styles.descriptionText}>
                {textData.page.screen.exhibitionModificationPage.longdescription}
              </div>
              <input
                type='text'
          ...
          <div className={styles.divBlockButtonModification}>
            ...
            <button
              type='submit'
              className={styles.divButtonSave}
            >
