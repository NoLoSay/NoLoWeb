    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...classes['buttonBox'],
            backgroundColor: isRecording ? 'var(--colors-base-button)' : 'var(--colors-button-disabled)',
          }}
        ...
        <div
          style={{
            ...classes['buttonBox'],
            backgroundColor: recordedChunks.length > 0 ? 'var(--colors-base-button)' : 'var(--colors-button-disabled)',
          }}
        ...
        >
          <button
            style={{
              ...classes['button'],
              backgroundColor:
                recordedChunks.length > 0 ? 'var(--colors-base-button)' : 'var(--colors-button-disabled)',
