...
const styles: { [key: string]: string } = {
  ...
  AboutDiv: 'sm:rounded-15xl rounded-[80px] w-4/5 overflow-hidden text-left text-base-white relative mb-12',
  TeamImg: 'w-full',
  ContentDiv:
  ...
  TeamText: 'font-black whitespace-pre-wrap inline-block text-[3rem] md:text-[2rem] sm:text-[1.5rem]',
}
      ...
      <div className={styles.container}>
        <div className={styles.AboutDiv}>
          ...
          <div className={styles.TeamTextDiv}>
            <div className={styles.TeamText}>{textData.page.screen.about.team}</div>
          </div>
        </div>
        <div className={styles.ContentDiv}>
          <span className={styles.ContentText}>{textData.page.screen.about.description}</span>
        </div>
        <Container />
        <Timeline />
      </div>
