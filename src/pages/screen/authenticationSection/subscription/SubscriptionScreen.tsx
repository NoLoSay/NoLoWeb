...
const styles: { [key: string]: string } = {
  ...
  noAccountButton: 'bg-transparent font-bold font-poppins hover:underline hover:cursor-pointer text-black',
}
  ...
  return (
    ...
    >
      <div className={`SubscriptionScreen/titleDiv ${styles['titleDiv']} ${styles['smTitleDiv']}`}>
        ...
        />
        <div className={`SubscriptionScreen/titleDivTextDiv ${styles['titleDivTextDiv']}`}>
          <p
      ...
      >
        ...
        />
        <div className={`SubscriptionScreen/formPasswordDiv ${styles['formPasswordDiv']}`}>
          <input
            className={`SubscriptionScreen/formInput ${styles['formInput']} ${styles['smFormInput']}`}
        ...
        <div className={`SubscriptionScreen/formPasswordDiv ${styles['formPasswordDiv']}`}>
          ...
          <input
            type='checkbox'
            onChange={() => setShowConfirmationPassword(!showConfirmationPassword)}
          />
        </div>
        <button className={`SubscriptionScreen/formConnectionButton ${styles['formConnectionButton']}`}>
          {textData.page.screen.authentificationSection.subscription.create}
        </button>
      </form>
      {error && <p className={`SubscriptionScreen/errorMessage ${styles['errorMessage']}`}>{error}</p>}
      <p className={`SubscriptionScreen/noAccountText ${styles['noAccountText']}`}>
