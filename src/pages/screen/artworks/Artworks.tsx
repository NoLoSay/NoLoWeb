      ...
      <Fragment>
        <div className={`divBlockTitlePage ${styles['divBlockTitlePage']}`}>
          <ButtonBase
            ...
            onClick={() => navigate(-1)}
          >
            <div className={styles.buttons}>{textData.page.screen.artworks.back}</div>
          </ButtonBase>
          ...
          >
            <div className={styles.buttons}>{textData.page.screen.artworks.add}</div>
          </ButtonBase>
        </div>
              ...
              >
                ...
                <div className={`divBlockExhibitionInfos ${styles['divBlockExhibitionInfos']}`}>
                  ...
                  <div className={`divBlockGoToArtworksBtn ${styles['divBlockGoToArtworksBtn']}`}>
                    ...
                    >
                      <div className={styles.buttons}>{textData.page.screen.artworks.modification}</div>
                    </ButtonBase>
                  </div>
                </div>
              </div>
