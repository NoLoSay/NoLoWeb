...
const styles: { [key: string]: string } = {
  ...
  cardImage: 'h-[218px] w-[129px] rounded-l-lg object-cover mq450:flex-1',
  cardDetails: 'flex-1 flex flex-col items-start justify-center py-4 pl-2  gap-[13px] min-w-[138px] p-[10px]',
