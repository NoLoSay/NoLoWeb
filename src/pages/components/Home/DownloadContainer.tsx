const styles: { [key: string]: string } = {
  ...
  castleImg: 'rounded-[4rem] w-full flex object-contain ' + 'md:rounded-3xl ' + 'sm:rounded-2xl',
    ...
    <div className={`DownloadContainer/mainDiv ${styles['mainDiv']}`}>
      ...
      <div className={`DownloadContainer/contentDiv ${styles['contentDiv']}`}>
        <div className={`DownloadContainer/textDiv ${styles['textDiv']}`}>
          <p className={`DownloadContainer/titleText ${styles['titleText']}`}>Nolosay,</p>
          <p className={`DownloadContainer/nolosayText ${styles['nolosayText']}`}>
          ...
          <img
            ...
            onClick={() => {
              window.location.href =
                'itms-services://?action=download-manifest&url=https://nolosay.fr/NoLoSay/manifest.plist'
            }}
          />
          <img
            className={`DownloadContainer/iconImg ${styles['iconImg']}`}
