...
const styles: { [key: string]: string } = {
  mainDiv: 'relative w-full bg-gray-300 px-14 py-14 text-white text-left font-poppins flex flex-row justify-between',
  smMainDiv: 'sm:py-8 sm:justify-normal sm:flex-col sm:gap-8',

  descriptionDiv: 'flex flex-col items-start justify-evenly gap-y-[1rem] flex-3',
  ...
  informationsDiv: 'informations flex flex-col items-start justify-evenly flex-1',
  ...
  aboutLink: 'text-base text-blue-400 hover:underline hover:cursor-pointer bg-transparent',
  container_0: 'w-32',
  container_1: 'w-4 h-4',
  container_2: 'w-4 h-4',
}
  ...
  return (
    <div className={`mainDiv ${styles['mainDiv']} ${styles['smMainDiv']}`}>
      ...
      <div className={`informationsDiv ${styles['informationsDiv']} ${styles['smInformationsDiv']}`}>
        ...
        <p className={`container_0 ${styles.container_0}`}>{textData.page.components.footer.mention}</p>
        <div className={`informationsContentDivs ${styles['informationsContentDivs']}`}>
          <img
