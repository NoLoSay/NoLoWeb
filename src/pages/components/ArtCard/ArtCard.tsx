              ...
              <div className={`container_9 ${styles.container_9}`}>
                <div>
                  ...
                  <div className={`container_13 ${styles.container_13}`}>
                    <p className={`container_14 ${styles.container_14}`}>{textData.page.components.artCard.autor}</p>
                    <p>{`Creator name`}</p>
                  </div>
                  ...
                  <div className={`container_17 ${styles.container_17}`}>
                    <p className={`container_18 ${styles.container_18}`}>{textData.page.components.artCard.place}</p>
                    <p>{`Nantes`}</p>
                  </div>
                </div>
              </div>
