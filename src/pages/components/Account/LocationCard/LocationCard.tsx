...
const styles: { [key: string]: string } = {
  container:
    "h-[200px] flex-1 flex flex-col items-start justify-start w-full text-left text-mini text-darkslategray font-poppins mq450:h-auto",
        ...
        <div className={`container_1 ${styles.container_1}`}>
          ...
          <div className={`container_2 ${styles.container_2}`}>
            <ButtonBase disableRipple onClick={handleCloseDelete}>
              <div className={styles.buttons}>Cancel</div>
            </ButtonBase>
            <ButtonBase disableRipple onClick={handleCloseDelete}>
              <div className={styles.buttons}>Delete</div>
            </ButtonBase>
          </div>
        </div>
      </Modal>
