...
const styles: { [key: string]: string } = {
  Map: 'min-w-[1493px] mt-8 gap-[35px] min-h-[893px] rounded-xl',
                    ...
                    <div className='rounded-xl flex flex-col items-start justify-center '>
                      <div className='rounded-1.5lg flex flex-row items-center gap-[10px]'>
                        <img
                          ...
                          loading='eager'
                          alt=''
                          src={place.pictures && place.pictures.length > 0 && place.pictures[0].hostingUrl ? place.pictures[0].hostingUrl : '/images/empty.jpg'}
                        />
