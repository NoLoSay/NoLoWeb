      ...
      <div style={{ ...classes["div"] }}>
        <div style={{ ...classes["div-2"] }}>
          ...
          <div style={{ ...classes["div-3"] }}>
            <div style={{ ...classes["text-wrapper"] }}>Créer un compte</div>
        ...
        <div style={{ ...classes["div-4"] }}>
          ...
          <div style={{ ...classes["s-inscrire-wrapper"] }}>
            <button style={{ ...classes["s-inscrire"] }}>
              Créer un compte
            </button>
          </div>
        </div>
        ...
        <p style={{ ...classes["exsisting-account"] }}>
          <span style={{ ...classes["span"] }}>Déjà un compte ? </span>
          <span style={{ ...classes["text-wrapper-6"] }}>Se connecter</span>
        </p>
      </div>
...
SubscriptionScreen.getLayout = function getLayout(page) {
