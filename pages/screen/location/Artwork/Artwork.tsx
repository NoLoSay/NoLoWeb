...
const styles: { [key: string]: string } = {
  ...
  container_1: "flex p-5 flex-col space-x-5 w-full items-center justify-around border-solid border-4 border-yellow-300",
        ...
        <div className={`container_2 ${styles.container_2}`}>
          <div className={`container_3 ${styles.container_3}`}>
            ...
            <div className={`container_6 ${styles.container_6}`}>
              <img src={imageSrc} alt="Image" className={`container_7 ${styles.container_7}`}/>
            </div>
